...
from rsl_rl.utils_np3o.helpers import hard_phase_schedualer, partial_checkpoint_load
...
class OnPolicyNP3O:
    ...
    def __init__(self,
        ...
        actor_critic: ActorCriticSwAV = actor_critic_class(self.env.cfg.env.n_proprio,
        ...
        #注释掉
        # if self.cfg['resume']:
        #     model_dict = torch.load(os.path.join(LEGGED_GYM_ROOT_DIR, self.cfg['resume_path']))
