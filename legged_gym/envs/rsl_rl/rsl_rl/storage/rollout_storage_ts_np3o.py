...
class RolloutStorageTSNP3O:
    ...
    def __init__(self, num_envs, num_transitions_per_env, obs_shape, 
                 privileged_obs_shape, history_obs_shape, actions_shape, 
    ...
    def compute_cost_returns(self, last_values, gamma, lam):
        ...
        # print("cost_violation = ", self.cost_violation[1])
        # print("cost_returns = ", self.cost_returns[1])
    ...
    def mini_batch_generator(self, num_mini_batches, num_epochs=8):
        ...
        cost_violations = self.cost_violation.flatten(0, 1)
        ...
        for epoch in range(num_epochs):
            for i in range(num_mini_batches):
                ...
                cost_violations_batch = cost_violations[batch_idx]

                old_mu_batch = old_mu[batch_idx]
                old_sigma_batch = old_sigma[batch_idx]
                yield obs_batch, critic_observations_batch, history_obs_batch,  \
                actions_batch, target_values_batch, advantages_batch, returns_batch, \
                target_cost_values_batch, cost_returns_batch, cost_advantages_batch, cost_violations_batch, \
